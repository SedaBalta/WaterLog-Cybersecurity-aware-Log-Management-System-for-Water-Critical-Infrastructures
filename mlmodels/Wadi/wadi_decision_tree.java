...
public class wadi_decision_tree {
    ...
    public static void main(String[] args) throws IOException{
        ...
        StructType schema = new StructType()
                .add("1_AIT_001_PV", DataTypes.DoubleType)
                .add("1_AIT_002_PV", DataTypes.DoubleType)
                .add("1_AIT_003_PV", DataTypes.DoubleType)
                .add("1_AIT_004_PV", DataTypes.DoubleType)
                .add("1_AIT_005_PV", DataTypes.DoubleType)
                .add("1_FIT_001_PV", DataTypes.DoubleType)
                .add("1_LS_001_AL", DataTypes.DoubleType)
                .add("1_LS_002_AL", DataTypes.DoubleType)
                .add("1_LT_001_PV", DataTypes.DoubleType)
                ...
                .add("2_PIT_001_PV", DataTypes.DoubleType)
                .add("2_PIT_002_PV", DataTypes.DoubleType)
                .add("2_PIT_003_PV", DataTypes.DoubleType)
                .add("2_SV_101_STATUS", DataTypes.DoubleType)
                .add("2_SV_201_STATUS", DataTypes.DoubleType)
                .add("2_SV_301_STATUS", DataTypes.DoubleType)
                .add("2_SV_401_STATUS", DataTypes.DoubleType)
                .add("2_SV_501_STATUS", DataTypes.DoubleType)
                .add("2_SV_601_STATUS", DataTypes.DoubleType)
                .add("2A_AIT_001_PV", DataTypes.DoubleType)
                .add("2A_AIT_002_PV", DataTypes.DoubleType)
                .add("2A_AIT_003_PV", DataTypes.DoubleType)
                .add("2A_AIT_004_PV", DataTypes.DoubleType)
                .add("2B_AIT_001_PV", DataTypes.DoubleType)
                .add("2B_AIT_002_PV", DataTypes.DoubleType)
                .add("2B_AIT_003_PV", DataTypes.DoubleType)
                .add("2B_AIT_004_PV", DataTypes.DoubleType)
                ...
                .add("3_AIT_005_PV", DataTypes.DoubleType)
                ...
                .add("Attack", DataTypes.IntegerType);
        ...
        Dataset<Row> df=spark
                ...
                .format("csv")
                .schema(schema)
                .load("/home/waterquality/IdeaProjects/SparkKafkaConsumer (copy)/src/main/resources/W1.csv");
      ...
      //  FIT101	LIT101	 MV101	P101	P102	 AIT201	AIT202	AIT203	FIT201	 MV201	 P201	 P202	P203	 P204	P205	P206	DPIT301	FIT301	LIT301	MV301	MV302	 MV303	MV304	P301	P302	AIT401	AIT402	FIT401	LIT401	P401	P402	P403	P404	UV401	AIT501	AIT502	AIT503	AIT504	FIT501	FIT502	FIT503	FIT504	P501	P502	PIT501	PIT502	PIT503	FIT601	P601	P602	P603	Normal/Attack
        ...
        VectorAssembler assembler = new VectorAssembler()
               // .setInputCols(new String[]{"MV201","LIT101",	 "MV101",	"P101",	"P102",	 "AIT201",	"AIT202","AIT203",	"FIT201",	 "MV201",	 "P201",	 "P202",	"P203",	 "P204",	"P205",	"P206",	"DPIT301",	"FIT301",	"LIT301",	"MV301",	"MV302",	 "MV303",	"MV304",	"P301",	"P302",	"AIT401",	"AIT402",	"FIT401",	"LIT401",	"P401",	"P402",	"P403",	"P404",	"UV401",	"AIT501",	"AIT502",	"AIT503",	"AIT504",	"FIT501",	"FIT502",	"FIT503",	"FIT504",	"P501",	"P502",	"PIT501",	"PIT502",	"PIT503",	"FIT601",	"P601",	"P602",	"P603"})
                .setInputCols(new String[]{
                        ...
                        "1_P_002_STATUS", "1_P_003_STATUS", "1_P_004_STATUS", "1_P_005_STATUS", "1_P_006_STATUS",
                        "2_DPIT_001_PV", "2_FIC_101_CO", "2_FIC_101_PV", "2_FIC_101_SP", "2_FIC_201_CO",
                        "2_FIC_201_PV", "2_FIC_201_SP", "2_FIC_301_CO", "2_FIC_301_PV", "2_FIC_301_SP",
                        "2_FIC_401_CO", "2_FIC_401_PV", "2_FIC_401_SP", "2_FIC_501_CO", "2_FIC_501_PV",
                        "2_FIC_501_SP", "2_FIC_601_CO", "2_FIC_601_PV", "2_FIC_601_SP", "2_FIT_001_PV",
                        "2_FIT_002_PV", "2_FIT_003_PV", "2_FQ_101_PV", "2_FQ_201_PV", "2_FQ_301_PV",
                        "2_FQ_401_PV", "2_FQ_501_PV", "2_FQ_601_PV", "2_LS_001_AL", "2_LS_002_AL",
                        "2_LS_101_AH", "2_LS_101_AL", "2_LS_201_AH", "2_LS_201_AL", "2_LS_301_AH",
                        "2_LS_301_AL", "2_LS_401_AH", "2_LS_401_AL", "2_LS_501_AH", "2_LS_501_AL",
                        "2_LS_601_AH", "2_LS_601_AL", "2_LT_001_PV", "2_LT_002_PV", "2_MCV_007_CO",
                        "2_MCV_101_CO", "2_MCV_201_CO", "2_MCV_301_CO", "2_MCV_401_CO", "2_MCV_501_CO",
                        "2_MCV_601_CO", "2_MV_001_STATUS", "2_MV_002_STATUS", "2_MV_003_STATUS",
                        "2_MV_004_STATUS", "2_MV_005_STATUS", "2_MV_006_STATUS", "2_MV_009_STATUS",
                        "2_MV_101_STATUS", "2_MV_201_STATUS", "2_MV_301_STATUS", "2_MV_401_STATUS",
                        "2_MV_501_STATUS", "2_MV_601_STATUS", "2_P_001_STATUS", "2_P_002_STATUS",
                        ...
                        "2_SV_501_STATUS", "2_SV_601_STATUS", "2A_AIT_001_PV", "2A_AIT_002_PV", "2A_AIT_003_PV",
        ...
        predictions.select("features_vector", "Attack", "prediction").show();
